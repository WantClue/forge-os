...
TEST_CASE("Parse stratum method", "[stratum]")
{
    ...
    TEST_ASSERT_EQUAL_INT(0, stratum_api_v1_message.mining_notification->clean_jobs);
}
...
TEST_CASE("Parse stratum mining.notify abandon work", "[stratum]")
{
    ...
    TEST_ASSERT_EQUAL(MINING_NOTIFY, stratum_api_v1_message.method);
    TEST_ASSERT_EQUAL_INT(1, stratum_api_v1_message.mining_notification->clean_jobs);
...
TEST_CASE("Parse stratum set_difficulty fractional params", "[mining.set_difficulty]")
{
